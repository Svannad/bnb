...
export default function Navigation() {
  return (
    <nav className="bg-white shadow-md p-4 flex gap-6 items-center">
      ...
      <NavLink to="/booking" className="text-gray-700 hover:text-red-500">Booking</NavLink>
      <NavLink to="/confirm" className="text-gray-700 hover:text-red-500">Confirm</NavLink>
