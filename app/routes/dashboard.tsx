...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  return { room, bookings: JSON.parse(JSON.stringify(bookings)), unavailableDates };
}

export default function Dashboard() {
  const { room, bookings, unavailableDates } = useLoaderData() as { room: any; bookings: any[], unavailableDates: any[]};
